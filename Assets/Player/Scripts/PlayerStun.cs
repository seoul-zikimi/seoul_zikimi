...
namespace Player
{
    ...
    public class PlayerStun : MonoBehaviour
    {
        ...
        public void Stun(float seconds) => StunWithToast(seconds, L.T("어질어질…", "Dizzy…"), new Color(1f, 0.9f, 0.3f));
        ...
        public void StunSlip(float seconds)
        {
            ...
            StunWithToast(seconds, L.T("미끄덩~", "Slippery~"), new Color(0.15f, 0.55f, 1f));
        }
